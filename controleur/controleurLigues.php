 ...
 *****************************************************************************************************/
$_SESSION['listeClubs'] = new Clubs(ClubDAO::lesClubs()); // Récupération de la liste des clubs
...
if (isset($_GET['ligue'])) {
    ...
    if (!isset($_SESSION['ligue'])) {
        $_SESSION['ligue'] = "0"; // Valeur par défaut si aucune ligue n'est sélectionnée
    }
}
...
if (isset($_GET['club'])) {
    ...
    if (!isset($_SESSION['club'])) {
        $_SESSION['club'] = "0"; // Valeur par défaut si aucun club n'est sélectionné
    }
}
...
// Make sure to provide necessary parameters to `creerMenu`
...
foreach ($_SESSION['listeClubs']->getClubs() as $unClub) {
    if($unClub->getIdLigue() == $_SESSION['ligue'] ){
...
/*****************************************************************************************************
 * Récupérer les clubs de la ligue sélectionnée
 *****************************************************************************************************/

/* $formInfosClubsLigue = new Formulaire('post', 'index.php', 'formInfosClubsLigue', 'formInfosClubsLigue');
        
 foreach ($_SESSION['listeClubs']->getClubs() as $unClub) {
    if($unClub->getIdLigue() == $_SESSION['ligue'] ){
        $formInfosClubsLigue->ajouterComposantLigne($formInfosClubsLigue->creerLabel('Nom club : ', 'infosClubLabel'), 1);
        $formInfosClubsLigue->ajouterComposantLigne($formInfosClubsLigue->creerLabel($unClub->getNomClub(), 'infosClubsLabel'), 1);
        $formInfosClubsLigue->ajouterComposantTab();
        $formInfosClubsLigue->ajouterComposantLigne($formInfosClubsLigue->creerLabel('Adresse club : ', 'infosClubLabel'), 1);
        $formInfosClubsLigue->ajouterComposantLigne($formInfosClubsLigue->creerLabel($unClub->getAdresseClub(), 'infosClubLabel'), 1);
        $formInfosClubsLigue->ajouterComposantTab();
...
// Créer le formulaire
$formInfosClubsLigue->creerFormulaire();
  */      
...
if ($_SESSION['ligue'] != "0") { // Assurez-vous que $LigueActive n'est pas nul
    // Ensure $ligueActive is not null
    $imagePath = $ligueActive->getImage();
    ...
    $formInfosLigue->ajouterComposantLigne($formInfosLigue->creerLabel($ligueActive->getNomLigue(), 'nomLigueLabel'), 1);
    ...
    $formInfosLigue->ajouterComposantLigne($formInfosLigue->creerLabel($ligueActive->getNomLigue(), 'infosLiguesLabel'), 1);
    $formInfosLigue->ajouterComposantTab();

    $formInfosLigue->ajouterComposantLigne($formInfosLigue->creerLabel('Site ligue: ', 'infosLigueLabel'), 1);
    $formInfosLigue->ajouterComposantLigne($formInfosLigue->creerLabel($ligueActive->getSite(), 'infosLigueLabel'), 1);
    $formInfosLigue->ajouterComposantTab();

    $formInfosLigue->ajouterComposantLigne($formInfosLigue->creerLabel('Descriptif ligue : ', 'infosLigueLabel'), 1);
    $formInfosLigue->ajouterComposantLigne($formInfosLigue->creerLabel($ligueActive->getDescriptif(), 'infosLigueLabel'), 1);
    $formInfosLigue->ajouterComposantTab();
} else {
...
if ($_SESSION['club'] != "0") { // Assurez-vous que $ClubActive n'est pas nul
