...
class Utilisateur{
    ...
    public function setIdClub($newIdClub) : void{
        $this->idClub = $newIdClub;
    }

    //Getter et setter de l'id fonctionnaire
    public function getIdFonct(): string{
        return $this->idFonct;
    }

    public function setIdFonct($newIdFonct) : void{
        $this->idFonct = $newIdFonct;
    }
}
?>
